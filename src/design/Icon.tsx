// 线描图标集 + Logo —— 移植自 app-design/project/src/c/tokens.jsx
...
const paths: Record<string, ReactNode> = {
  upload: (
    <>
      <path d="M8 11V3M8 3L5.5 5.5M8 3L10.5 5.5" />
      <path d="M3 11v1.5A1.5 1.5 0 0 0 4.5 14h7a1.5 1.5 0 0 0 1.5-1.5V11" />
    </>
  ),
  file: (
    <>
      <path d="M4 2.5A1.5 1.5 0 0 1 5.5 1h4L13 4.5v8A1.5 1.5 0 0 1 11.5 14h-6A1.5 1.5 0 0 1 4 12.5z" />
      <path d="M9.5 1v3.5H13" />
    </>
  ),
  folder: (
    <path d="M2 5.5A1.5 1.5 0 0 1 3.5 4h2.4l1.2 1.5h5.4A1.5 1.5 0 0 1 14 7v4.5A1.5 1.5 0 0 1 12.5 13h-9A1.5 1.5 0 0 1 2 11.5z" />
  ),
  search: (
    <>
  ...
  ai: (
    <path
      d="M5 2l.8 2.2L8 5l-2.2.8L5 8l-.8-2.2L2 5l2.2-.8zM11 7l.6 1.7L13 9l-1.7.6L11 11l-.6-1.7L9 9l1.7-.6z"
      fill="currentColor"
      stroke="none"
    />
  ),
  ...
  sliders: (
    <>
      <path d="M3 4h6M11 4h2M3 8h2M7 8h6M3 12h8M13 12h0" />
  ...
  book: (
    <>
      <path d="M2.5 3v10A1.5 1.5 0 0 0 4 14.5h9.5V3.5A1.5 1.5 0 0 0 12 2H4a1.5 1.5 0 0 0-1.5 1.5z" />
  ...
  paperclip: (
    <path d="M11 5l-5 5a2 2 0 0 0 2.8 2.8L14 7.5a3.5 3.5 0 0 0-5-5l-6 6a5 5 0 0 0 7 7l4-4" />
  ),
  quote: (
    <path
      d="M4 9c0-2 1-3 2.5-3.5L6 4C3.5 4.5 2 6.5 2 9.5V12h4V9zM10 9c0-2 1-3 2.5-3.5L12 4c-2.5.5-4 2.5-4 5.5V12h4V9z"
      fill="currentColor"
      stroke="none"
    />
  ),
  diff: (
    <>
      <path d="M5 2v8M5 10a2 2 0 0 0 2 2h2M11 14V6M11 6a2 2 0 0 0-2-2H7" />
